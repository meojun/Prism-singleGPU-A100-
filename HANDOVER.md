...
| 마이그레이션이 임계 경로 밖이다 | 위약 대조로 재측정하니 근처 요청이 TTFT 1.30배 — **임계 경로에 있다** | `v4/v5_2-analysis/q1_*` |
| KV 손실이 비싸다 | 위약 대조 TPOT 1.04 / E2E 0.93 — 잃어도 거의 손해가 없다 | `v4/v5_2-analysis/q4_*` |
| Moore-Hodgson 의 과소 수용 | steady 8 에서 **1161/1161 수용, deferred 0** 인데 goodput 39% 손실 | `v5/summary.csv` |
...
**중앙값 0.84초(≈ 엔진 자체 teardown 0.96초), 평균 3.45초, 최대 12.52초.** 대부분은
