...
TAU=$(python3 -c "import json;print(json.load(open('$PRISM_EXP/results/paper-faithful-tp/calibration/tau.json'))['tau'])" 2>/dev/null || echo 0.171086)

EXP="tp-aa-${ARM}_r${RATE}_s${SEED}"
OUTDIR=$OUTBASE/$EXP
