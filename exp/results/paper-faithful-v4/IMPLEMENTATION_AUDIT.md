...
| NVLink / P2P weight migration | NOT IMPLEMENTED | NOT IMPLEMENTED | PARTIAL | v4 fills the target from the source GPU's resident weights over NVLink; microbenchmark shows x2.4 lower latency and NVLink counters equal to the full model size. Not observed end to end (see REPORT). |
